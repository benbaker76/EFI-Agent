...
// https://github.com/gxjones/ImageWriter/blob/master/RaspberryPiSDWriter/DiskUtilController.m
...
{
	MainViewController *mainViewController = (MainViewController *)context;
	...
	[mainViewController.disksArray addObject:foundDisk];
	
	[foundDisk release];
	
	[mainViewController.disksArray sortUsingFunction:diskSort context:nil];
	
	updateDiskList(mainViewController.disksArray, mainViewController.efiBootDeviceUUID);
	
	[mainViewController refreshDisks];
}
...
void diskDisappearedCallback(DADiskRef disk, void *context)
{
	...
	for (Disk *foundDisk in mainViewController.disksArray)
	{
		if ([mediaBSDName isEqualToString:foundDisk.mediaBSDName])
		{
			[mainViewController.disksArray removeObject:foundDisk];
